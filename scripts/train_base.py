...
"""
Train the base Physics-Informed VAE model on cell migration data.
"""
...
from models.composite.pivae import PhysicsInformedVAE
from training.trainer import Trainer

def main():
    """Main function to train the base PIVAE model"""
    # Parse command line arguments
    parser = argparse.ArgumentParser(description="Train base Physics-Informed VAE model")
    parser.add_argument("--input", "-i", type=str, required=True, 
                        help="Path to processed cell migration data")
    parser.add_argument("--output-dir", "-o", type=str, default="results/base_model",
    ...
    with open(config_path, 'w') as f:
        f.write("Base Physics-Informed VAE Training Configuration\n")
        f.write("=============================================\n\n")
